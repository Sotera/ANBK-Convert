...
//this is the secret sauce that looks at URLs to figure out if a call should be routed
//to the App server or ReST server. This will get a lot more complicated and wind up
//in its own export module
exports.determineRoute = function (url) {
    return (url.indexOf('/spool/') == 0 || url.indexOf('/re/resources/') == 0)
        ? 'rest'
        : 'local'
}
